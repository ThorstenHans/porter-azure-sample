...
# PORTER_MIXINS
# RUN chmod a+rx $BUNDLE_DIR/terraform/.terraform/providers/registry.terraform.io/hashicorp/azurerm/3.11.0/linux_amd64/terraform-provider-azurerm_v3.11.0_x5
RUN chown -R ${BUNDLE_USER} ${BUNDLE_DIR}/terraform
